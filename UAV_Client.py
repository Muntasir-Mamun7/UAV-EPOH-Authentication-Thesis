# UAV_Client.py - Final Code with Standardized Path and Clean Landing
# This script ensures a minimum 60-second authenticated flight for thesis data collection.
...
# --- Configuration (MUST MATCH GCS_LeaderNode.py) ---
UAV_SUPI = 'UAV_A1'           # Subscriber Identity (ID)
LONG_TERM_KEY = 'K_LongTerm_A1' # Long-Term Symmetric Key (K)
GCS_HOST = '127.0.0.1'        
GCS_PORT = 50001
# Windows Host IP for AirSim connection (Based on your ipconfig output)
